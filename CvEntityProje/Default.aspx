<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CvEntityProje._default" %>
...
<body>
    <div class="sidenav text-center">
        <div class="side_top">
            ...
            <h1 class="top_hd mt-2"><a href="index.html">Hüseyin Bozkurt</a></h1>
            <p class="top_hdp mt-2">Siber Güvenlil Uzmanı</p>
        </div>
        <!-- header -->
            ...
            <div class="nav-top">
                <nav class="mnu mx-auto">
                    ...
                    <ul class="menu">
                        ...
                        <li class="mt-sm-3"><a href="#about" class="scroll">Eğtim Hayatım</a></li>
    ...
    <div class="main">
        ...
        <section class="slide-wrapper" id="about">
            <h2 class="w3_head mb-4">Eğtim Hayatım </h2>

            <p class="iner mt-md-5">
                <asp:Repeater ID="Repeater2" runat="server">
                    <ItemTemplate><%# Eval("EGTIM") %></ItemTemplate>
                </asp:Repeater>
            </p>
        </section>
        <!-- //about -->
